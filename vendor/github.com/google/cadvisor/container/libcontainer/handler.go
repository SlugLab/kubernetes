...
func setMemoryStats(s *cgroups.Stats, ret *info.ContainerStats) {
	...
	if cgroups.IsCgroup2UnifiedMode() {
		...
		ret.Memory.RSS1 = s.MemoryStats.PageUsageByNUMA.Total.Nodes[0] >> 20
		ret.Memory.RSS2 = s.MemoryStats.PageUsageByNUMA.Total.Nodes[1] >> 20
		if len(s.MemoryStats.PageUsageByNUMA.Total.Nodes) > 2 {
			ret.Memory.RSS3 = s.MemoryStats.PageUsageByNUMA.Total.Nodes[2] >> 20
			ret.Memory.RSS4 = s.MemoryStats.PageUsageByNUMA.Total.Nodes[3] >> 20
		}
