...
func setMemoryStats(s *cgroups.Stats, ret *info.ContainerStats) {
	...
	if cgroups.IsCgroup2UnifiedMode() {
		...
		ret.Memory.RSS1 = s.MemoryStats.PageUsageByNUMA.Anon.Nodes[0]
		ret.Memory.RSS2 = s.MemoryStats.PageUsageByNUMA.Anon.Nodes[1]
		if len(s.MemoryStats.PageUsageByNUMA.Anon.Nodes) > 2 {
			ret.Memory.RSS3 = s.MemoryStats.PageUsageByNUMA.Anon.Nodes[2]
			ret.Memory.RSS4 = s.MemoryStats.PageUsageByNUMA.Anon.Nodes[3]
		}
