...
func TestValidateResourceQuotaWithAlphaLocalStorageCapacityIsolation(t *testing.T) {
	spec := core.ResourceQuotaSpec{
		Hard: core.ResourceList{
			...
			core.ResourceRequestNodeLimits1:           resource.MustParse("10000"),
			core.ResourceRequestNodeLimits2:           resource.MustParse("10000"),
			core.ResourceRequestNodeLimits3:           resource.MustParse("10000"),
			core.ResourceRequestNodeLimits4:           resource.MustParse("10000"),
				...
				Spec: core.PodSpec{
					Containers: []core.Container{{
						...
						Resources: core.ResourceRequirements{
							...
							Limits: core.ResourceList{
								core.ResourceName("node_limit1"): resource.MustParse("2"),
							},
						},
					}},
					RestartPolicy: core.RestartPolicyAlways,
