...
var podComputeQuotaResources = sets.NewString(
	...
	string(core.ResourceNodeLimit1),
	string(core.ResourceNodeLimit2),
	string(core.ResourceNodeLimit3),
	string(core.ResourceNodeLimit4),
	string(core.ResourceLimitsCPU),
	string(core.ResourceLimitsMemory),
	string(core.ResourceLimitsNodeLimits1),
	string(core.ResourceLimitsNodeLimits2),
	string(core.ResourceLimitsNodeLimits3),
	string(core.ResourceLimitsNodeLimits4),
	string(core.ResourceRequestsCPU),
	string(core.ResourceRequestsMemory),
	string(core.ResourceRequestNodeLimits1),
	string(core.ResourceRequestNodeLimits2),
	string(core.ResourceRequestNodeLimits3),
	string(core.ResourceRequestNodeLimits4),
)
